...
public class gettingRope2 {
    public static void main(String[] args) {
        ...
        // if you just import it will import only the mthods nothing else
        // and when importing it will not execute main class -- > remember that //
    }
}
